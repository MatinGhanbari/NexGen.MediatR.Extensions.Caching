...
/// <summary>
/// Emulates the server-side compare-and-swap the Garnet provider performs through scripting:
/// a write only lands when the stored document still matches the one the caller merged from.
/// </summary>
internal sealed class GarnetCompareAndSwapIndexStore : IContainerIndexStore
{
    private readonly IDistributedCache _readCache;
    private readonly IDistributedCache _authoritative;
    private readonly object _gate;

    public GarnetCompareAndSwapIndexStore(IDistributedCache readCache, IDistributedCache authoritative, object gate)
    {
