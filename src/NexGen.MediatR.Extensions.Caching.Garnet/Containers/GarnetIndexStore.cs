...
/// Garnet instance merge the container indexes without losing each other's entries.
/// </summary>
internal sealed class GarnetIndexStore : IContainerIndexStore
{
    /// <summary>
